...
- (void)setupLabels {
	label = [[UILabel alloc] initWithFrame:CGRectMake(0,0,300,120)];
...
- (void)layoutSubviews {
    ...
    {
        detailsLabel.frame=CGRectMake(0,self.bounds.size.height-110,320,75);
    }
    ...
    else
    {
        ...
        if ([sharedDefaults boolForKey:@"FirstLaunch"])
        {
            ...
            self.size =CGSizeMake(detailsLabel.frame.size.width, detailsLabel.frame.size.height);
...
- (void)drawRect:(CGRect)rect {
   ...
   // NSLog(@"drawRect...BG Drawing else BG Drawing");
    NSUserDefaults  *sharedDefaults = [NSUserDefaults standardUserDefaults];
    if ([sharedDefaults boolForKey:@"FirstLaunch"])
    {
    ...
    else
    {
        ...
        if (dimBackground) {
            ...
            CGFloat gradLocations[2] = {0.0f, 1.0f};//1.0f, 1.0f, 1.0f, 0.1f
...
//- (void)drawRect:(CGRect)rect {
//	NSLog(@"drawRect.. Drawing");
// //   AppDelegate *appDelegate;
//    
////    if(appDelegate.isFirstHud)
////    {
////        
////    }
////    else
